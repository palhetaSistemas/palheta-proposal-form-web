...
import { activitiesTasks } from "./tasks";
import {
  CheckCircle2,
  ChevronDown,
  ChevronRight,
...
export const activitiesSubTasks = generateSubTasks(6);

export type activitySubTaskType = (typeof activitiesSubTasks)[number];
