...
import { budgetsBoards } from "./boards";

export const budgetsTasks = [
  {
    boardId: budgetsBoards[2].id,
...
export type budgetTaskType = (typeof budgetsTasks)[number];
