...
import { projectsTasks } from "./tasks";
...
export const projectsSubTasks = generateSubTasks(6);

export type projectSubTaskType = (typeof projectsSubTasks)[number];
