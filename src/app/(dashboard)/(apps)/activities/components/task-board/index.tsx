...
const TaskBoard = ({ boards, tasks, subTasks }: TaskBoardProps) => {
  ...
  const [selectedBoardId, setSelectedBoardId] = React.useState<
    activityBoardType["id"] | undefined
  >(undefined);
  const [selectedBoard, setSelectedBoard] = React.useState<
    activityBoardType | undefined
  >(undefined);
  // for task
  const [selectedTaskId, setSelectedTaskId] = React.useState<
    activityTaskType["id"] | undefined
  >(undefined);
  ...
  // handle edit board
  const openEdit = (board: activityBoardType) => {
  ...
  const handleTaskOpener = (boardId: activityBoardType["id"]) => {
  ...
  // update task handler
  const updateTaskHandler = (task: activityTaskType) => {
