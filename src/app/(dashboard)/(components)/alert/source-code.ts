export const colorAlert = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
const ColorAlert = () => {
  return (
    <React.Fragment>
      <Alert>
...
`;
export const outlineAlert = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
const OutlineAlert = () => {
  return (
    <React.Fragment>
...
`;
export const softAlert = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
const SoftAlert = () => {
  return (
    <React.Fragment>
      <Alert variant="soft">
...
export const linkAlert = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
const LinkAlert = () => {
  return (
    <React.Fragment>
      <Alert variant="soft">
...
`;
export const disableAlert = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
const DisableAlert = () => {
  return (
    <React.Fragment>
      <Alert dismissible>
...
`;
export const dismissibleOutlineAlert = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
...
`;
export const dismissibleSoftColor = `import { Alert, AlertDescription, AlertTitle } from "@/src/components/ui/alert";
