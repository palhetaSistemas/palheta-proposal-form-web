export const avatarLetter = `import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
...
;
`;
export const avatarsTonal = `import { Avatar, AvatarFallback } from "@/src/components/ui/avatar";
...
export const avatarSize = `import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
import { faker } from "@faker-js/faker";
const AvatarSize = () => {
  return (
    <React.Fragment>
...
`;
export const avatarBorder = `import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
import { faker } from "@faker-js/faker";
const AvatarBorder = () => {
  return (
    <React.Fragment>
...
`;
export const avatarBorderColor = `import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
import { faker } from "@faker-js/faker";
