...
`;
export const outlineBadge = `import { Badge } from "@/src/components/ui/badge";
...
`;
export const softBadge = `import { Badge } from "@/src/components/ui/badge";
...
`;
export const badgesStyle = `import { Badge } from "@/src/components/ui/badge";
...
`;
export const dotStyleBadge = `import { Badge } from "@/src/components/ui/badge";
import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
import { faker } from "@faker-js/faker";
const DotStyleBadge = () => {
  return (
...
`;
export const badgeAlignment = `import { Badge } from "@/src/components/ui/badge";
import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
import { faker } from "@faker-js/faker";
...
`;
export const badgeVisibility = `import { Badge } from "@/src/components/ui/badge";
import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar";
import { faker } from "@faker-js/faker";
