  ...
  return (
    <div className="space-y-5">
      ...
      <Card title="Menu Type" code={menuTypeBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          On select any Item of{" "}
          <span className="text-primary">Breadcrumb </span> the single item will
          be selected and stay active and other item will be unselected also
          there will be no separator also show like button. It is possible to
          use the Breadcrumbs component as a horizontal menu.
        </p>
        <div>
          <MenuTypeBreadcrumb />
        </div>
