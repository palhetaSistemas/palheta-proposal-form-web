...
const DialogWithProgressbar = () => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-base font-medium text-warning">
            {" "}
            Almost out of storage{" "}
          </DialogTitle>
        </DialogHeader>
        <div>
          <div className="text-sm font-semibold text-default-950 mb-2">
            Approaching Full Capacity
          </div>
          <p className="text-xs text-default-700">
            If you run out, you can't back up photos, or send and receive any
            documents.
          </p>
        </div>
