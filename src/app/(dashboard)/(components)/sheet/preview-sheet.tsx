        ...
        <div className="h-[calc(100vh-120px)]">
          <ScrollArea className="h-full">
            <div className="px-5 py-6">
              <span className="mb-4 block text-lg text-default-900 ">
                Personal
              </span>
              ...
              <ul className="md:grid grid-cols-2 gap-2 space-y-2 md:space-y-0">
                ...
                <li className="col-span-2">
                  ...
                  <span className="text-default-500 ">
                    ...
                    databases, compiler theory, computer architecture,
                    Microcomputer Principle and Interface Technology, Computer
