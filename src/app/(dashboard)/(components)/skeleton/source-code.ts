export const defaultSkeleton = `import { Skeleton } from "@/src/components/ui/skeleton";
...
`;
export const profileSkeleton = `import { Skeleton } from "@/src/components/ui/skeleton";
...
`;
export const readMoreSkeleton = `import { Skeleton } from "@/src/components/ui/skeleton";
