...
export const centerTimeline = `import { Timeline, TimelineItem, TimelineContent, TimelineDot, TimelineConnector, TimelineSeparator } from "@/src/components/ui/timeline";
