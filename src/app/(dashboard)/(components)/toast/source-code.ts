...
export const defaultToast = `import { toast } from "@/src/components/ui/use-toast";";
const Toast = () => {
const defaulToast = () =>
  toast({
...
export const dangerToast = `import { toast } from "@/src/components/ui/use-toast";";
const Toast = () => {
...
export const warningToast = `import { toast } from "@/src/components/ui/use-toast";";
const Toast = () => {
const warning = () =>
  toast({
...
export const successToast = `import { toast } from "@/src/components/ui/use-toast";";
const Toast = () => {
const success = () =>
  toast({
    title: "Success",
...
export const infoToast = `import { toast } from "@/src/components/ui/use-toast";";
const Toast = () => {
const info = () =>
  toast({
