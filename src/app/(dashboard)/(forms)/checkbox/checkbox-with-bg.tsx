  ...
  return (
    <div className="space-y-5">
      <Label
        htmlFor="cbbg1"
        className={cn(
          "bg-default-100 dark:bg-default-200  h-10 px-2 rounded-md w-full flex justify-between items-center",
          {
            "bg-primary": checked1,
          }
        )}
      >
        <span
          className={cn("text-default-600", {
            "text-primary-foreground": checked1,
          })}
        >
          I'm number one.
        </span>
      ...
      >
        <span
          className={cn("text-default-600", {
            "text-primary-foreground": checked2,
          })}
        >
          I'm number two.
        </span>
