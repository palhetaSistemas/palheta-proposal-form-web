    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-9 gap-y-5">
      ...
      <div className="border py-2 rounded-md bg-background">
        ...
        <Input
          ...
          variant="ghost"
          size="sm"
          className="text-lg focus:border-0"
        />
      </div>
      ...
      <div className="relative">
        <input
          type="text"
          id="floatingLabel1"
          className="block bg-background  px-3 pb-2.5 pt-6 w-full text-sm text-default-900 border border-border rounded-md appearance-none focus:outline-none focus:ring-0  peer"
          placeholder=""
        />
        <label
          htmlFor="floatingLabel1"
      ...
      <div className="relative ">
        <input
          type="text"
          id="floatingLabel2"
          className="block  px-3 pb-2.5 pt-6 w-full text-sm text-default-900 border-b  border-border bg-default-100 rounded-md focus:border-primary appearance-none focus:outline-none focus:ring-0  peer"
          placeholder=""
        />
        <label
          htmlFor="floatingLabel2"
          className="absolute text-sm text-default-500  duration-300 transform -translate-y-3.5 scale-75 top-4 z-10 origin-[0] start-2.5 
             peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 
             rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto"
        >
