...
const CustomImplementation = () => {
  ...
  return (
    <div>
      <RadioGroup defaultValue="cr_1" onValueChange={handleValueChange}>
        <Label
          className={cn(
            "flex justify-between items-center w-full border border-default-400 p-4 rounded-md",
            {
