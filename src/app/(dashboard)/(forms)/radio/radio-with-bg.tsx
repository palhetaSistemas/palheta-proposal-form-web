    ...
    <div>
      <RadioGroup defaultValue="rwb_1" onValueChange={handleValueChange}>
        <Label
          htmlFor="rwb_1"
          className={cn(
            "flex justify-between items-center gap-1 bg-default-100 dark:bg-default-200 px-3 py-2.5 w-full rounded-md cursor-pointer",
        ...
        >
          ...
          <RadioGroupItem
            value="rwb_1"
            id="rwb_1"
            className="data-[state=checked]:text-primary-foreground data-[state=checked]:border-primary-foreground"
          ></RadioGroupItem>
        </Label>
        <Label
          htmlFor="rwb_2"
