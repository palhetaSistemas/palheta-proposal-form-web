export const defaultRating = `import { Rating } from "@/src/components/ui/rating";
...
`;
export const disabledRating = `import { Rating } from "@/src/components/ui/rating";
...
`;
export const halfStarRating = `import { Rating } from "@/src/components/ui/rating";
...
`;
export const readOnlyRating = `import { Rating } from "@/src/components/ui/rating";
...
`;
export const outlineRating = `import { Rating } from "@/src/components/ui/rating";
const OutlineRating = () => {
  return (
    <Rating
      style={{ maxWidth: 125 }}
...
`;
export const sizeRating = `import { Rating } from "@/src/components/ui/rating";
...
`;
export const radioGroupRating = `import { Rating } from "@/src/components/ui/rating";
import { useState } from "react";
