        ...
        <div className="w-5/6 h-full justify-center flex flex-col gap-2">
          <div className="flex w-full items-center justify-end">
            <div className="flex items-center gap-2">
              <div className="flex w-[575px] text-end flex-col">
          ...
          <div className="w-full h-2/6 flex items-center gap-8">
            ...
            <div className="h-full w-1/4 rounded-3xl flex flex-col overflow-hidden">
              <Image
                src="/images/staticDataImage/facade2.png"
                alt=""
                width={1200}
              ...
              />
              <div className="w-full border border-primary rounded-b-3xl h-1/2 gap-2 text-primary flex flex-col p-8">
                ...
                <span className="text-sm">PORTO VELHO, RONDÔNIA</span>
              </div>
            </div>
            <div className="h-full w-1/4 rounded-3xl flex flex-col overflow-hidden">
              <Image
              ...
              <div className="w-full border border-primary rounded-b-3xl h-1/2 gap-2 text-primary flex flex-col p-8">
                ...
                <span className="text-sm">VENCESLAU BRÁS, PARANÁ</span>
              </div>
            </div>
          </div>
        </div>
