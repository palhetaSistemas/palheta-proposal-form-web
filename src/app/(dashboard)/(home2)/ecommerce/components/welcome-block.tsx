    ...
    <Card className="p-0 overflow-hidden">
      <CardContent className="p-0 relative">
        ...
        <Image
          ...
          alt="shape image"
          className={cn(
            "w-[140px] h-16 absolute bottom-0 left-1/2 -translate-x-1/2",
            {
              "invert sepia": theme === "dark",
            }
          )}
        ...
        <div className="grid grid-cols-12 gap-6 px-6 py-2 items-center relative">
          <div className="col-span-12 lg:col-span-8">
            <div className="text-3xl font-semibold text-default-900">
              {" "}
              Welcome Back <span className="text-primary">Prantik!</span>{" "}
            </div>
            <div className="text-3xl font-semibold text-default-900">
              Check Dashboard
            </div>
