...
const ParticleColorMap = () => {
  ...
  const sourceLongitude = useCallback(
    (d: MapFlowDataRecord) => d.sourceLon,
    []
  );
  const targetLatitude = useCallback((d: MapFlowDataRecord) => d.targetLat, []);
  const targetLongitude = useCallback(
    (d: MapFlowDataRecord) => d.targetLon,
    []
  );
  const flowParticleDensity = useCallback(
    (d: MapFlowDataRecord) => d.particleDensity,
    []
  );
  ...
  const flowParticleColor = hslToHex(
