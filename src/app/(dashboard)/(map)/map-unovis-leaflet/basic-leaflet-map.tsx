...
const BasicLeafletMap = () => {
  ...
  const pointLatitude = useCallback(
    (mapData: MapPointDataRecord) => mapData.latitude,
    []
  );
  const pointLongitude = useCallback(
    (mapData: MapPointDataRecord) => mapData.longitude,
    []
  );
  const pointBottomLabel = useCallback(
    (mapData: MapPointDataRecord) => mapData.id,
    []
  );
